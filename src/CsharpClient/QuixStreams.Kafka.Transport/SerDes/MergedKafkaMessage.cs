...
namespace QuixStreams.Kafka.Transport.SerDes
{
    ...
    public class MergedKafkaMessage : KafkaMessage
    {
        ...
        public MergedKafkaMessage(ICollection<KafkaMessage> segments, byte[] key, byte[] value, IDictionary<string, byte[]> headers, TopicPartitionOffset topicPartitionOffset) : base(key, value, headers)
        {
