...
{
    /// <summary>
    /// Builder for managing <see cref="TimeseriesDataTimestamp"/> instances on <see cref="TimeseriesBufferWriter"/> 
    /// </summary>
    public class TimeseriesDataBuilder
    {
        private readonly TimeseriesBufferWriter buffer;
        ...
        /// </summary>
        /// <param name="buffer">The <see cref="TimeseriesBufferWriter"/> to adds to</param>
        /// <param name="data">Instance of TimeseriesData to modify</param>
        /// <param name="timestamp">Data package managed by the builder</param>
        public TimeseriesDataBuilder(TimeseriesBufferWriter buffer, TimeseriesData data, TimeseriesDataTimestamp timestamp)
        {
            this.buffer = buffer;
            this.data = data;
