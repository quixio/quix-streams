...
{
    /// <summary>
    /// Builder for creating <see cref="ParameterDefinition"/> for <see cref="StreamParametersWriter"/>
    /// </summary>
    public class ParameterDefinitionBuilder
    {
        ...
        /// </summary>
        /// <param name="streamParametersWriter">Parameters writer owner</param>
        ...
        public ParameterDefinitionBuilder(StreamParametersWriter streamParametersWriter, string location, Process.Models.ParameterDefinition definition = null)
        {
            this.streamParametersWriter = streamParametersWriter;
        ...
        /// <summary>
        /// Add new parameter definition to the <see cref="StreamPropertiesWriter"/>. Configure it with the builder methods.
        /// </summary>
        ...
        {
            this.definition = this.streamParametersWriter.CreateDefinition(this.location, parameterId, name, description);
