...
//         private TimeseriesBufferData? timeseriesBufferData;
//
...
//             lock (this._lock)
//             {
//                 if (timeseriesBufferData is null)
//                 {
//                     timeseriesBufferData = BufferOps.Get(timeseriesDataRaw);
//                 }
...
//                     {
//                         BufferOps.AddTimestampToBuffer(timeseriesBufferData.Value, timeseriesDataRaw, i);
...
//                             bufferedFrames.Add((startIndex, i - startIndex, timeseriesBufferData.Value));
//                             
//                             FlushData(false);
//
//                             startIndex = i;
...
//                             bufferedFrames.Add((startIndex, i - startIndex + 1, timeseriesBufferData.Value));
//
//                             FlushData(false);
//
//                             startIndex = i + 1;
...
//                         this.bufferedFrames.Add((startIndex, timeseriesDataRaw.Timestamps.Length - startIndex, timeseriesBufferData.Value));
//                     }
//                 }
//
