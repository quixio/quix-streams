...
using Quix.Streams.Telemetry.Models.Codecs;
using Quix.Streams.Telemetry.Models.Telemetry.Parameters.Codecs;
using Quix.Streams.Transport.Fw;
using Quix.Streams.Transport.Fw.Codecs;
using Xunit;

namespace Quix.Streams.Telemetry.UnitTests.Models.Telemetry
{
