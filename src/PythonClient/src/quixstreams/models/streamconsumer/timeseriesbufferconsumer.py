...
class TimeseriesBufferConsumer(TimeseriesBuffer):
    ...
    def __init__(self, topic_consumer, stream_reader, net_pointer: ctypes.c_void_p = None):
        """
        ...
        TimeseriesBuffer.__init__(self, topic_consumer, stream_reader, net_pointer)
