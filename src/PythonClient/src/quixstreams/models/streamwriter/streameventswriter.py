...
from ...native.Python.QuixSdkStreaming.Models.StreamWriter.StreamEventsWriter import StreamEventsWriter as sewi
...
class StreamEventsWriter(object):
    ...
    def __init__(self, net_pointer: ctypes.c_void_p):
        """
            ...
            net_pointer: Pointer to an instance of a .net StreamEventsWriter.
        """

        if net_pointer is None:
            raise Exception("StreamEventsWriter is none")

        self._interop = sewi(net_pointer)
