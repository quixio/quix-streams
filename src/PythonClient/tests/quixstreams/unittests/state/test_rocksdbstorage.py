...
from src.quixstreams.state.rocksdbstorage import RocksDbStorage
...
class RocksDbStorageTests(unittest.TestCase):
    ...
    @staticmethod
    def create_in_rocksdb_storage():
        return RocksDbStorage("dasdsa")

    def test_setget_float(self):
        # Arrange
        storage = RocksDbStorageTests.create_in_rocksdb_storage()
        storage.clear()
