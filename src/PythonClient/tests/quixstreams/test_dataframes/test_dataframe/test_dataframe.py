...
class TestDataframeProcess:
    ...
    def test_row_apply_fluent(
        ...
        assert dataframe.process(row_with_ints) == row_plus_n(3, row_with_ints)
    ...
    def test_set_item_column_with_function(
        ...
        expected = row_msg_value_factory({
            **msg_value_with_ints,
            'new_val': msg_value_with_ints['x'] + 10
        })
        actual = dataframe.process(row_with_ints)
        assert actual == expected
    ...
    def test_set_item_column_with_operations(
        ...
        expected = row_msg_value_factory({
            **msg_value_with_ints,
            'new_val': msg_value_with_ints['x'] + (msg_value_with_ints['y'] + 10) + 1})
        actual = dataframe.process(row_with_ints)
        assert actual == expected
    ...
    def test_column_subset_with_funcs(
            self, dataframe, row_with_ints, msg_value_with_ints,
            row_plus_n_func, row_msg_value_factory
    ):
        n = 1
        key_list = ['x', 'y']
    ...
    def test_multiple_row_generation(
            ...
            row_with_list, msg_value_with_list,
    ):
