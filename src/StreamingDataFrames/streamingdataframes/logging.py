...
_LOGGER_NAME = "streamingdataframes"
...
def configure_logging(
    ...
    """
    Configure "streamingdataframes" logger.

    .. note:: If "streamingdataframes" logger already has pre-defined handlers
    ...
    if logger.handlers:
        # There's a pre-configured handler for "streamingdataframes", leave it as it is
        return False
