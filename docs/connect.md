...
Once you have [obtained the token](https://www.quix.io/docs/develop/authentication/streaming-token.html) you will have to provide it as an argument to `QuixStreamingClient` or set the `Quix__Sdk__Token` environment variable. This is shown in the following code:
