...
Once you have [obtained the token](../platform/how-to/streaming-token.md) you will have to provide it as an argument to `QuixStreamingClient` or set the `Quix__Sdk__Token` environment variable. This is shown in the following code:
