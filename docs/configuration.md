...
For the full list of parameters see the [Application API docs](/docs/quix-streams/api-reference/application/#application__init__).
...
See the [Stateful Processing](/docs/quix-streams/advanced/stateful-processing/#fault-tolerance-recovery) page to learn more about changelog topics.   
**Default** - `True`.
