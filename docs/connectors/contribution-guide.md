...
1. Check out [one of the issues with a `connector` label](https://github.com/quixio/quix-streams/labels/connector) in case the connector has already been submitted.
