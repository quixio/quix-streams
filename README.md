...
```shell
pip install --extra-index-url https://test.pypi.org/simple/ quixstreams==0.5.0.dev13 --user
```
...
19. Install Quix Streams:
    ...
    ```
    python3 -m pip install --extra-index-url https://test.pypi.org/simple/ quixstreams==0.5.0.dev13 --user
    ```
