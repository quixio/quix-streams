...
from quixstreams.dataframe.windows import CountSlidingWindowDefinition


@pytest.fixture()
def count_sliding_window_definition_factory(state_manager, dataframe_factory):
    def factory(count: int, step: int) -> CountSlidingWindowDefinition:
        sdf = dataframe_factory(state_manager=state_manager)
        window_def = CountSlidingWindowDefinition(dataframe=sdf, count=count, step=step)
        return window_def
...
class TestCountSlidingWindow:
    ...
    def test_count(self, count_sliding_window_definition_factory, state_manager):
        window_def = count_sliding_window_definition_factory(count=4, step=2)
    ...
    def test_sum(self, count_sliding_window_definition_factory, state_manager):
        window_def = count_sliding_window_definition_factory(count=4, step=2)
    ...
    def test_mean(self, count_sliding_window_definition_factory, state_manager):
        window_def = count_sliding_window_definition_factory(count=4, step=2)
    ...
    def test_reduce(self, count_sliding_window_definition_factory, state_manager):
        window_def = count_sliding_window_definition_factory(count=4, step=2)
    ...
    def test_max(self, count_sliding_window_definition_factory, state_manager):
        window_def = count_sliding_window_definition_factory(count=4, step=2)
    ...
    def test_min(self, count_sliding_window_definition_factory, state_manager):
        window_def = count_sliding_window_definition_factory(count=4, step=2)
    ...
    def test_collect(self, count_sliding_window_definition_factory, state_manager):
        window_def = count_sliding_window_definition_factory(count=4, step=2)
    ...
    def test_unaligned_steps(
        self, count_sliding_window_definition_factory, state_manager
    ):
        window_def = count_sliding_window_definition_factory(count=5, step=2)
        window = window_def.collect()
        window.register_store()
        store = state_manager.get_store(topic="test", store_name=window.name)
        store.assign_partition(0)
