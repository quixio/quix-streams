...
class TestWindowedRocksDBPartitionTransaction:
    ...
    def test_expire_windows_expired(self, windowed_rocksdb_store_factory, delete):
        ...
        with store.start_partition_transaction(0) as tx:
            ...
            max_start_time = tx.get_latest_id(prefix=prefix) - duration_ms
    ...
    def test_expire_windows_with_grace_expired(self, windowed_rocksdb_store_factory):
        ...
        with store.start_partition_transaction(0) as tx:
            ...
            max_start_time = tx.get_latest_id(prefix=prefix) - duration_ms - grace_ms
    ...
    def test_get_latest_id_update(self, windowed_rocksdb_store_factory):
        store = windowed_rocksdb_store_factory()
    ...
    def test_get_latest_id_cannot_go_backwards(self, windowed_rocksdb_store_factory):
        store = windowed_rocksdb_store_factory()
        partition = store.assign_partition(0)
        timestamp = 9
        prefix = b"__key__"
