...
class DataframeRegistry:
    ...
    def register_groupby(self, source_sdf_topic: str, new_sdf: "StreamingDataFrame"):
        """
        Register a "groupby" SDF, which is one generated with `SDF.group_by()`.
        :param source_sdf_topic: the topic from the origin SDF used by `sdf.group_by()`
        :param new_sdf: the SDF generated by `sdf.group_by()`.
        """
        if self._repartition_origins.get(source_sdf_topic):
        ...
        self._repartition_origins[new_sdf.topic.name] = source_sdf_topic
