import logging
from typing import Any, Iterable, Optional, Protocol, Tuple, TypeVar
...
class WindowedPartitionTransaction(Protocol[V]):
    @property
    ...
    def as_state(self, prefix: bytes) -> WindowedState[Any, V]: ...
